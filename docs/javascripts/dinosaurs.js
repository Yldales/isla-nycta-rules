    ...
    return `
      <span class="tier-wrapper">
        <span class="tier-name">
          <a href="${BASE_URL}/pot/${type}/${tier}/${name}.html">
            ${match}
          </a>
        </span>
